...
const Navbar: React.FC = () => {
  ...
  return (
    <>
          ...
          <div className="relative">
            ...
            {showUserMenu && (
              <>
                ...
                <div className="absolute right-0 mt-2 w-64 max-w-[calc(100vw-2rem)] bg-white rounded-xl shadow-xl border border-slate-200 py-2 z-50 animate-in fade-in slide-in-from-top-2">
      ...
      {activeSos && (
        <div className="fixed top-16 sm:top-20 left-3 right-3 sm:left-auto sm:right-4 z-50 max-w-md bg-rose-950/95 border border-rose-500 text-white px-4 py-3 rounded-xl shadow-2xl flex items-center space-x-3 backdrop-blur-md animate-bounce">
          <Radio className="w-5 h-5 sm:w-6 sm:h-6 text-rose-400 animate-pulse shrink-0" />
          <div className="min-w-0">
            <p className="text-xs font-black uppercase tracking-wider text-rose-300 truncate">Emergency SOS Broadcast Active</p>
            <p className="text-[11px] sm:text-xs text-rose-100 leading-snug">Live GPS Coordinates transmitted to Central Dispatch & Patrol Units.</p>
          </div>
        </div>
      )}
      ...
      {editProfileModalOpen && (
        <div className="fixed inset-0 bg-slate-950/70 backdrop-blur-sm z-[9999] flex items-center justify-center p-3 sm:p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-sm w-full p-5 sm:p-6 relative max-h-[90vh] overflow-y-auto">
