...
exports.logger = winston_1.default.createLogger({
    ...
    format: combine(timestamp({ format: 'YYYY-MM-DD HH:mm:ss' }), winston_1.default.format.errors({ stack: true }), process.env.NODE_ENV === 'development' ? colorize() : winston_1.default.format.uncolorize(), logFormat),
    transports: [
